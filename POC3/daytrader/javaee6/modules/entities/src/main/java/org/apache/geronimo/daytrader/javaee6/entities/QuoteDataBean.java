...
@NamedNativeQueries({
    @NamedNativeQuery(name="quoteejb.quoteForUpdate", query="select * from quoteejb q where q.symbol=? for update",resultClass=org.apache.geronimo.daytrader.javaee6.entities.QuoteDataBean.class)
})
